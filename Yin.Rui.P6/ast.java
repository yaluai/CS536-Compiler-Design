...
abstract class ASTnode { 
    ...
    static int curLocals = 0;
    static int maxLocals = 0;
}
...
class ProgramNode extends ASTnode {
    ...
    public void nameAnalysis() {
        ...
        for (DeclNode i : myDeclList.myDecls) {
            if (i instanceof FnDeclNode && ((FnDeclNode) i).myId.name().equals("main")) {
                hasMain = true;
            }
        }
        if (!hasMain) {
    ...
    public void codegen() {
        ...
        if (Codegen.useStringEq) {
            Codegen.generate(".text");
            Codegen.genLabel(Codegen.stringEqFunc);
            Codegen.generateIndexed("lb", Codegen.T0, Codegen.A0, 0);
            Codegen.generateIndexed("lb", Codegen.T1, Codegen.A1, 0);
            Codegen.generate("addiu", Codegen.A0, Codegen.A0, 1);
            Codegen.generate("addiu", Codegen.A1, Codegen.A1, 1);
            Codegen.generate("seq", Codegen.V0, Codegen.T0, Codegen.T1);
            String end = Codegen.nextLabel();
            Codegen.generate("beqz", Codegen.V0, end);
            Codegen.generate("bnez", Codegen.T0, Codegen.stringEqFunc);
            Codegen.generateLabeled(end, "jr", "", Codegen.RA);
        }
    }
...
class DeclListNode extends ASTnode {
    ...
    public void codegen() {
        // gen main function first
        for (DeclNode node : myDecls) {
            if (node instanceof FnDeclNode && ((FnDeclNode) node).myId.name().equals("main")) {
                node.codegen();
                break;
            }
        }
...
class FnBodyNode extends ASTnode {
    ...
    public void typeCheck(Type retType) {
        ...
        for (DeclNode i : myDeclList.myDecls) {
            ((VarDeclNode) i).myId.sym().isLocal = true;
            ((VarDeclNode) i).myId.sym().offset = -12 - 4 * ASTnode.curLocals++;
            ASTnode.maxLocals++;
        }

        myStmtList.typeCheck(retType);

        locals = ASTnode.maxLocals;
    }    
...
class ExpListNode extends ASTnode {
    ...
    public void codegen() {
        for (ExpNode e : myExps) {
            ...
            Codegen.generateIndexed("sw", Codegen.V0, Codegen.SP, 0);
        }
    }
...
class FnDeclNode extends DeclNode {
     ...
     */
    public void typeCheck() {
        int k = myFormalsList.myFormals.size();
        for (FormalDeclNode i : myFormalsList.myFormals) {
            i.myId.sym().isLocal = true;
            i.myId.sym().offset = --k * 4;
        }
    ...
    public void codegen() {
        ...
        // save $ra
        Codegen.generateIndexed("sw", Codegen.RA, Codegen.SP, -4);
        // save $fp
        Codegen.generateIndexed("sw", Codegen.FP, Codegen.SP, -8);
        // set $fp
        Codegen.generate("move", Codegen.FP, Codegen.SP);
        // alloc locals+2
        Codegen.generate("addiu", Codegen.SP, Codegen.SP, -4 * (2 + myBody.locals));

        Codegen.returnLabel = "_" + myId.name() + "_Exit";

        myBody.codegen();

        // exit
        Codegen.genLabel(Codegen.returnLabel);
        // dealloc locals+2
        Codegen.generate("addiu", Codegen.SP, Codegen.SP, 4 * (2 + myBody.locals));
        // restore $fp
        Codegen.generateIndexed("lw", Codegen.FP, Codegen.SP, -8);
        // restore $ra
        Codegen.generateIndexed("lw", Codegen.RA, Codegen.SP, -4);
...
class PostIncStmtNode extends StmtNode {
    ...
    public void codegen() {
        ...
        Codegen.generate("addiu", Codegen.V0, 1);
        id.codegenStore();
    }
...
class ReadStmtNode extends StmtNode {
    ...
    public void codegen() {
        ...
        if (id.sym().getType() instanceof BoolType) {
            // non-zero to 1
            Codegen.generate("sne", Codegen.V0, Codegen.V0, Codegen.ZERO);
        }
...
class IfStmtNode extends StmtNode {
    ...
    public void typeCheck(Type retType) {
        ...
        for (DeclNode i : myDeclList.myDecls) {
            ((VarDeclNode) i).myId.sym().isLocal = true;
            ((VarDeclNode) i).myId.sym().offset = -12 - 4 * ASTnode.curLocals++;
            if (ASTnode.curLocals > ASTnode.maxLocals) {
                ASTnode.maxLocals = ASTnode.curLocals;
            }
        }
        
        myStmtList.typeCheck(retType);

        ASTnode.curLocals -= myDeclList.myDecls.size();
    }
...
class IfElseStmtNode extends StmtNode {
    ...
    public void typeCheck(Type retType) {
        ...
        for (DeclNode i : myThenDeclList.myDecls) {
            ((VarDeclNode) i).myId.sym().isLocal = true;
            ((VarDeclNode) i).myId.sym().offset = -12 - 4 * ASTnode.curLocals++;
            if (ASTnode.curLocals > ASTnode.maxLocals) {
                ASTnode.maxLocals = ASTnode.curLocals;
        ...
        ASTnode.curLocals -= myThenDeclList.myDecls.size();

        for (DeclNode i : myElseDeclList.myDecls) {
            ((VarDeclNode) i).myId.sym().isLocal = true;
            ((VarDeclNode) i).myId.sym().offset = -12 - 4 * ASTnode.curLocals++;
            if (ASTnode.curLocals > ASTnode.maxLocals) {
                ASTnode.maxLocals = ASTnode.curLocals;
        ...
        myElseStmtList.curLocals -= myElseDeclList.myDecls.size();
    }
    ...
    public void codegen() {
        myExp.codegen();
        String else_ = Codegen.nextLabel();
        String end = Codegen.nextLabel();
        Codegen.generate("beqz", Codegen.V0, else_);
        myThenStmtList.codegen();
        Codegen.generate("j", end);
        Codegen.genLabel(else_);
...
class ReturnStmtNode extends StmtNode {
    ...
    public void codegen() {
        ...
        Codegen.generate("j", Codegen.returnLabel);
    }
...
class IdNode extends ExpNode {
    ...
    public void codegen() {
        if (mySym.isLocal) {
            ...
            Codegen.generateIndexed("lw", Codegen.V0, Codegen.T0, 0);
        }
    }

    public void codegenStore() {
        if (mySym.isLocal) {
            Codegen.generateIndexed("sw", Codegen.V0, Codegen.FP, mySym.offset);
        } else {
            Codegen.generate("la", Codegen.T0, "." + myStrVal);
...
class CallExpNode extends ExpNode {
    ...
    public void codegen() {
        ...
        Codegen.generate("addiu", Codegen.SP, Codegen.SP, 4 * myExpList.myExps.size());
    }
...
class UnaryMinusNode extends UnaryExpNode {
    ...
    public void codegen() {
        myExp.codegen();
        Codegen.generate("negu", Codegen.V0, Codegen.V0);
    }
}
...
class NotNode extends UnaryExpNode {
    ...
    public void codegen() {
        myExp.codegen();
        Codegen.generate("seq", Codegen.V0, Codegen.V0, Codegen.ZERO);
    }
}
...
abstract class ArithmeticExpNode extends BinaryExpNode {
    ...
    public void codegen() {
        ...
        // pop rhs
        Codegen.generateIndexed("lw", Codegen.V1, Codegen.SP, 0);
        Codegen.generate("addiu", Codegen.SP, Codegen.SP, 4);
        ...
        if (this instanceof PlusNode) {
            ...
            op = "subu";
        } else if (this instanceof TimesNode) {
            op = "mul";
        } else if (this instanceof DivideNode) {
            op = "div";
        }

        Codegen.generate(op, Codegen.V0, Codegen.V0, Codegen.V1);
    }
}
...
abstract class LogicalExpNode extends BinaryExpNode {
    ...
    public void codegen() {
        myExp1.codegen();
        String end = Codegen.nextLabel();
        Codegen.generate(this instanceof AndNode ? "beqz" : "bnez", Codegen.V0, end);
        myExp2.codegen();
        Codegen.genLabel(end);
    }
}
...
abstract class EqualityExpNode extends BinaryExpNode {
    ...
    public void codegen() {
        if (myExp1 instanceof StringLitNode) {
            Codegen.useStringEq = true;

            // compare string
            myExp2.codegen();
            // move $a1, $a0
            Codegen.generate("move", Codegen.A1, Codegen.A0);

            myExp1.codegen();

            // call compare string func
            Codegen.generate("jal", Codegen.stringEqFunc);

            if (this instanceof NotEqualsNode) {
                Codegen.generate("seq", Codegen.V0, Codegen.V0, Codegen.ZERO);
            }
        } else {
            myExp2.codegen();
            ...
            Codegen.generate(this instanceof EqualsNode ? "seq" : "sne",
                             Codegen.V0, Codegen.V0, Codegen.V1);
        }
    }
}
...
abstract class RelationalExpNode extends BinaryExpNode {
    ...
    public void codegen() {
        ...
        String op = "?";
        if (this instanceof LessNode) {
            op = "slt";
        } else if (this instanceof LessEqNode) {
            op = "sle";
        } else if (this instanceof GreaterNode) {
            op = "sgt";
        } else if (this instanceof GreaterEqNode) {
            op = "sge";
        }
